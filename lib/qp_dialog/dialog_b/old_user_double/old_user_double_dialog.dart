...
class OldUserDoubleDialog extends StatelessWidget{
  bool init=false;
  late OldUserDoubleCon oldUserCon;
  ...
  Widget build(BuildContext context){
    if(!init){
      oldUserCon=Get.put(OldUserDoubleCon());
      init=true;
    }
    return WillPopScope(
      child: Material(
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        QpImg(img: "icon_wheel",width: 92.w,height: 92.w,),
                        Container(
                          ...
                          child: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              QpText(text: "+\$$wheelAddNum", size: 14.sp, color: "#FFFFFF"),
                    ...
                    SizedBox(width: 28.w,),
                    QpText(text: "+", size: 30.sp, color: "#1E5D76"),
                    SizedBox(width: 28.w,),
                    Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        QpText(text: "Double Claim", size: 20.sp, color: "#FFFFFF",fontWeight: FontWeight.bold,)
                      ],
                    )
                  ],
                ),
