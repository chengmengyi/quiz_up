...
class WheelGuideOverlay extends StatelessWidget{
  Offset offset;
  Function() dismiss;
  WheelGuideOverlay({required this.offset,required this.dismiss});
          ...
          child: Stack(
            children: [
              Positioned(
                top: offset.dy,
                left: offset.dx,
                child: QpImg(img: "pro6",width: 60.w,height: 60.w,),
              ),
              Positioned(
                top: offset.dy+60,
                right: 0,
                child: Container(
                  ...
                  child: QpText(text: "Pass 10 questions to \nget a lucky spin!", size: 14.sp, color: "#351900"),
                ),
              ),
              Positioned(
                top: offset.dy+10.w,
